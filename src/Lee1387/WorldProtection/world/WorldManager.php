...
class WorldManager
{
    ...
    public static function init(): void 
    {
        ...
        foreach ($worlds as $world) {
            ...
            $configPath = $worldPath . "worldprotection.yml";
    ...
    {
        $worldName = $world->getDisplayName();
        if (!WorldManager::isLoaded($worldName)) false;
        if (!in_array($property, WorldManager::ARRAY_PROPERTIES)) false;
